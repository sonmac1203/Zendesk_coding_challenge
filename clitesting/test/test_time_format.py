...
class DateTestCase(unittest.TestCase):
    ...
    def test_date(self):
        formatted_date_1 = get_date(self.unformatted_1)
        self.assertEqual(formatted_date_1, '2001-03-12')
        formatted_date_2 = get_date(self.unformatted_2)
        self.assertEqual(formatted_date_2, '2010-06-08')

    def test_time(self):
        formatted_time_1 = get_time(self.unformatted_1)
        self.assertEqual(formatted_time_1, '21:50:50')
        formatted_time_2 = get_time(self.unformatted_2)
